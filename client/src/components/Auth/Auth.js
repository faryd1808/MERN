  ...
  return (
    <Container component="main" maxWidth="xs">
      <Paper className={classes.paper} elevation={6}>
        ...
        <Typography component="h1" variant="h5">{ isSignup ? 'Registrate' : 'Iniciar Sesion' }</Typography>
        <form className={classes.form} onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Input name="email" label="Correo" handleChange={handleChange} type="email" />
            ...
            { isSignup && <Input name="confirmPassword" label="Repita la contraseña" handleChange={handleChange} type="password" /> }
          </Grid>
          <Button type="submit" fullWidth variant="contained" color="primary" className={classes.submit}>
            { isSignup ? 'Regristrarse' : 'Iniciar sesión' }
          </Button>
          <GoogleLogin
